...
#Perform haplocall
angsd -b references/new_bams.filelist -doHaploCall 1 -doCounts 1 -out inter.files/1.haplo/${cur_chr}  -r ${cur_chr} -maxMis ${maxmis} -sites references/pobi.snps.by.chr/${cur_chr}.se.pobi.bim.chr.pos.txt
